        ...
        <div className="row justify-content-center position-relative">
          <div className="col-12 px-2" style={{ maxWidth: '100%' }}>
            ...
            <div className="container bg-transparent">
              ...
              <div className="player-skeleton custom-bg custom-theme-radius-low p-2">
              ...
              <div className="container custom-bg custom-theme-radius-low w-100 p-2 my-2">
                <div className="dynamic-ts py-2">
                  {/* Grey box for Server Label */}
                  <div className="player-skeleton-placeholder custom-theme-radius-low bd-callout-dark" style={{ width: '150px', height: '20px' }}></div>
                </div>
                <div className="row g-2">
                  <div className="col-4 col-sm-3 col-md-4 col-lg-3 col-xl-2">
                    <button className="btn w-100 border-0 rounded-pill shadow-sm btn-grey bd-callout-dark">
                      <span className="player-skeleton-placeholder custom-theme-radius-low bd-callout-dark" style={{ width: '80%', height: '18px' }}></span>
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="d-flex flex-column align-items-start custom-theme-radius-low my-2 w-100">
                <div className="container py-2">
                  <div className="dynamic-ts">
                    ...
                    <div className="player-skeleton-placeholder custom-theme-radius-low bd-callout-dark" style={{ width: '100px', height: '20px' }}></div>
                  </div>
