...
const Alert = ({ message, onClose, type }) => {
  ...
  return (
    <div 
      className={`alert position-fixed bd-callout-${alertType} p-2 custom-theme-radius fade show fixed-bottom mx-auto`} role="alert"
      style={{ width: '90%', zIndex: 9999, bottom: '10px', left: '50%', transform: 'translateX(-50%)' }}
    >
      <div className="d-flex justify-content-between align-items-center text-white">
        <span className="ps-2"><i className="bi bi-bell-fill me-2"></i>{message}</span>
